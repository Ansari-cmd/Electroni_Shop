...
from store_app.models import Order, OrderItem,Product,Categories,Filter_Price,Color,Brand,Tag,Contact_us
...
def Contact_Page(request):
    if request.method == 'POST':
        ...
        try:
            send_mail(subject,message,email_from,['awantikaroy2612@gmail.com'])
            contact.save()
...
def WHISHLIST(request):
    return render(request,'Cart/whishlist.html')
